        ...
        if (length && length > 2 && data[0] == '4' && data[1] == '2')
        {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    cout << "highest unnormalized weight " << highest_weight << endl;
                    cout << "average unnormalized weight " << weight_sum/num_particles << endl;
